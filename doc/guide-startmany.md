...
If you are using a masternode.conf file you no longer need the helium.conf file. The exception is if you need custom settings (thanks oblox). 
...
And compare with the official explorer at http://heliumexplorer.coin-server.com <or> dnet.presstab.pw
